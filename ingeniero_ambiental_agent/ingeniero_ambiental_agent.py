...
DEFAULT_MODEL = os.getenv("INGENIERO_AMBIENTAL_MODEL", "claude-sonnet-5")
...
informe (encontrado real, 2026-08-19: pasó en una corrida de este agente — fuentes_y_cobertura
tenía 7 búsquedas reales documentadas, pero el informe_completo no las mencionaba).
"""
...
def build_input_desde_frente(
    ...
    quedaron conectados a este frente — se suman al input para que una corrida formal también
    los tenga disponibles, no solo el Conductor.
