...
| Tests | `km_tools/tests/` — `tests/test_ingest.py` (ingest_corrida) archivado con él 2026-08-15. Estado real de verde/rojo: ver deuda de tests, `agents.md` § Estado operativo (generado). | — | ⚠️ ver deuda de tests |
